...
BROAD_HELP_PATTERNS = {
    ...
    "why join jain university",
    "why should i join jain university",
    "benefits of jain university",
}

FOLLOW_UP_REFERENCES = {
    "it", "they", "that", "this one", "the above one", "above", "same", "that one",
}
...
RAG_HINTS = {
    ...
    "ctc", "salary", "average", "highest", "lowest", "offer", "offers",
    "submitted", "submission", "lab", "assignment", "faculty", "teacher",
    "event", "events", "calendar", "holiday", "holidays", "schedule",
    "timetable", "semesterwise", "2026",
}
